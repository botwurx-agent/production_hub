// Small stroke-based inline icons matching the marketing-site style
// (~stroke-width 2, rounded caps). Kept inline to avoid an icon dependency.
...
export function BoardsIcon({ className }: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill={svg} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <rect x="6.5" y="6.5" width="5" height="7" rx="1" />
      <rect x="13.5" y="6.5" width="4" height="4" rx="1" />
      <rect x="6.5" y="15.5" width="11" height="2" rx="1" />
    </svg>
  );
}
...
export function PlusIcon({ className }: IconProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill={svg} stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" className={className}>
